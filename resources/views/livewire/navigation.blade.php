 ...
 class="bg-gray-700 bg-opacity-25 w-full absolute hidden" id="navigation-menu">
    ...
    <div class="bg-white h-full overflow-y-auto">
        ...
        @auth
            <a href="{{route("profile.show")}}" class="py-2 px-8 text-sm flex items-center text-gray-500 hover:bg-orange-500 hover:text-white">
            ...
            <a href="" 
                ...
                class="py-2 px-8 text-sm flex items-center text-gray-500 hover:bg-orange-500 hover:text-white">
                <span class="justify-center w-9 flex">
        ...
        @else
        <a href="{{route("login")}}" class="py-2 px-8 text-sm flex items-center text-gray-500 hover:bg-orange-500 hover:text-white">
            <span class="justify-center w-9 flex">
                <i class="fa fa-user-check"></i>
            </span>
            Login
        </a>
        <a href="{{route("register")}}" class="py-2 px-8 text-sm flex items-center text-gray-500 hover:bg-orange-500 hover:text-white">
            <span class="justify-center w-9 flex">
